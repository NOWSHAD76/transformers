...
class Gemma3ThinkerConfig(PretrainedConfig):
    ...
    sub_configs = {
        "text_config": Gemma3WithTalkerTextConfig,
        "vision_config": SiglipVisionConfig,
    }

    def __init__(
        self,
        text_config: Optional[Union[Gemma3WithTalkerTextConfig, Dict[str, Any]]] = None,
        ...
        **kwargs,
        ...
        if text_config is None:
            text_config = Gemma3WithTalkerTextConfig()
            logger.info("text_config is None, using default Gemma3ThinkerTextConfig text config.")
        elif isinstance(text_config, dict):
            text_config = Gemma3WithTalkerTextConfig(**text_config)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if thinker_config is None:
            thinker_config = Gemma3ThinkerConfig()
            logger.info("thinker_config is None, using default Gemma3ThinkerConfig config.")
        ...
        if isinstance(talker_config, dict):
            ...
            talker_config = Gemma3TalkerConfig()
            logger.info("talker_config is None, using default Gemma3TalkerConfig config.")
        if isinstance(token2wav_config, dict):
            token2wav_config = Gemma3Token2WavConfig(**token2wav_config)
        elif token2wav_config is None:
            token2wav_config = Gemma3Token2WavConfig()
            logger.info("token2wav_config is None, using default Gemma3Token2WavConfig config.")
...
__all__ = ["Gemma3ThinkerConfig", "Gemma3TalkerConfig", "Gemma3Token2WavConfig", "Gemma3WithTalkerConfig"]
